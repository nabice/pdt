 ...
 *     Zend Technologies
 *******************************************************************************/
package org.eclipse.php.internal.core.compiler.ast.parser.php8;
...
public abstract class PHPTokenNames {
	...
	static {
		...
		token2Name.put(CompilerParserConstants.T_POW_EQUAL, "**="); //$NON-NLS-1$
		...
		token2Name.put(CompilerParserConstants.T_ELLIPSIS, "..."); //$NON-NLS-1$
		...
		token2Name.put(CompilerParserConstants.T_POW, "**"); //$NON-NLS-1$
		...
		token2Name.put(CompilerParserConstants.T_YIELD, "yield"); //$NON-NLS-1$
		...
		token2Name.put(CompilerParserConstants.T_LIST, "list"); //$NON-NLS-1$
